 ...
 * 响应体统一使用 {@code Result.FAIL(code, msg)} 格式。
 */
@Slf4j
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Result> handleBusinessException(BusinessException e) {
        ...
        Result body = e.getData() == null
                ? Result.FAIL(codeEnum.getCode(), e.getMessage())
                : Result.FAIL(codeEnum.getCode(), e.getMessage(), e.getData());
    ...
    public ResponseEntity<Result> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        String message = e.getBindingResult().getFieldErrors().stream()
                ...
                .findFirst()
                .orElse("参数校验失败");
        Result body = Result.FAIL(CodeEnum.PARAM_ERROR.getCode(), message);
    ...
    public ResponseEntity<Result> handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
        ...
        Result body = Result.FAIL(CodeEnum.PARAM_ERROR.getCode(), "请求体格式错误");
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(body);
    }
    ...
    public ResponseEntity<Result> handleMissingServletRequestPartException(MissingServletRequestPartException e) {
        ...
        Result body = Result.FAIL(CodeEnum.PARAM_ERROR.getCode(), "缺少必要的请求部分: " + e.getRequestPartName());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(body);
    }
    ...
    public ResponseEntity<Result> handleAccessDeniedException(AccessDeniedException e) {
        ...
        Result body = Result.FAIL(CodeEnum.ACCESS_DENIED);
    ...
    public ResponseEntity<Result> handleDuplicateKeyException(DuplicateKeyException e) {
        ...
        Result body = Result.FAIL(CodeEnum.DUPLICATE);
    ...
    public ResponseEntity<Result> handleDataAccessException(DataAccessException e) {
        ...
        Result body = Result.FAIL(CodeEnum.DATA_ACCESS_EXCEPTION);
    ...
    public ResponseEntity<Result> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
        ...
        Result body = Result.FAIL(CodeEnum.FAIL.getCode(), "不支持的请求方法: " + e.getMethod());
    ...
    public ResponseEntity<Result> handleRuntimeException(RuntimeException e) {
        ...
        Result body = Result.FAIL(CodeEnum.SYSTEM_ERROR.getCode(), "系统繁忙，请稍后重试");
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(body);
    }
