...
import com.autodealer.crm.service.AuditLogService;
...
public class AuditLogController {
    ...
    public R<TLoginLog> getLoginLog(@PathVariable Integer id) {
        return R.OK(auditLogService.getLoginLog(id));
    }
    ...
    public R<TOperationLog> getOperationLog(@PathVariable Integer id) {
        return R.OK(auditLogService.getOperationLog(id));
    }
