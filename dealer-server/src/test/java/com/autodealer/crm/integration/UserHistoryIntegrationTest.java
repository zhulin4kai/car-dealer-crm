...
class UserHistoryIntegrationTest extends BackendIntegrationTestBase {
    ...
    void cleanHistory() {
        ...
        jdbcTemplate.update("INSERT INTO t_organization_unit(id,code,name,type,parent_id,order_no,placeholder,enabled,version,create_time,create_by) VALUES(?, 'HISTORY_ADMIN_ORG', '历史审计组织', 'DEPARTMENT', 1, 1, 0, 1, 0, CURRENT_TIMESTAMP, 1)", HISTORY_ADMIN_ORG_ID);
        ...
        jdbcTemplate.update("INSERT INTO t_organization_unit(id,code,name,type,parent_id,order_no,placeholder,enabled,version,create_time,create_by) VALUES(?, 'HISTORY_OUTSIDE_ORG', '历史范围外组织', 'DEPARTMENT', 1, 1, 0, 1, 0, CURRENT_TIMESTAMP, 1)", HISTORY_OUTSIDE_ORG_ID);
