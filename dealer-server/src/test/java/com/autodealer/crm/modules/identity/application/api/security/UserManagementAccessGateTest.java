...
class UserManagementAccessGateTest {
    ...
    private TUser user(boolean protectedAccount) {
        ...
        user.setAccountType(protectedAccount ? com.autodealer.crm.modules.identity.application.api.enums.AccountType.SYSTEM
                : com.autodealer.crm.modules.identity.application.api.enums.AccountType.HUMAN);
        return user;
    }
}
