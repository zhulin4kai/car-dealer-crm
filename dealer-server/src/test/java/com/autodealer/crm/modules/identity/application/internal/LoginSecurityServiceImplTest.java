...
import com.autodealer.crm.modules.identity.application.internal.LoginSecurityServiceImpl;
...
class LoginSecurityServiceImplTest {
    ...
    void soleOrdinaryAdministratorIsKeptAvailable() {
        ...
        com.autodealer.crm.modules.identity.persistence.model.TRole admin=new com.autodealer.crm.modules.identity.persistence.model.TRole();admin.setRole("admin");
