...
class RedisKeyGovernanceTest {
    ...
    void transactionCacheKeys_shouldOnlyKeepActiveProductsAndInvoicesCaches() throws Exception {
        String constantsSource = Files.readString(SOURCE_ROOT.resolve("com/autodealer/crm/constant/Constants.java"));
        String redisKeysSource = Files.readString(SOURCE_ROOT.resolve("com/autodealer/crm/constant/RedisKeys.java"));
        String tranServiceSource = Files.readString(SOURCE_ROOT.resolve("com/autodealer/crm/service/impl/TranServiceImpl.java"));
        String completionServiceSource = Files.readString(
                SOURCE_ROOT.resolve("com/autodealer/crm/service/impl/TransactionCompletionServiceImpl.java"));
    ...
    void redisKeys_shouldNotHaveCompatibilityConstantsOrListCacheEntrypoints() throws Exception {
        String constantsSource = Files.readString(SOURCE_ROOT.resolve("com/autodealer/crm/constant/Constants.java"));
        String redisKeysSource = Files.readString(SOURCE_ROOT.resolve("com/autodealer/crm/constant/RedisKeys.java"));
        String redisManagerSource = Files.readString(SOURCE_ROOT.resolve("com/autodealer/crm/manager/RedisManager.java"));
        String tokenFilterSource = Files.readString(
                SOURCE_ROOT.resolve("com/autodealer/crm/config/filter/TokenVerifyFilter.java"));
        String loginHandlerSource = Files.readString(
                SOURCE_ROOT.resolve("com/autodealer/crm/config/handler/MyAuthenticationSuccessHandler.java"));
        String logoutHandlerSource = Files.readString(
                SOURCE_ROOT.resolve("com/autodealer/crm/config/handler/MyLogoutSuccessHandler.java"));
